/*!
 * This driver provides access to the auxiliary functions of the Kinect:
 *   accelerometer, tilt, and LED.
 *
 * One can use it in parallel with the ni driver.
 *
 * cf <a href="http://www.ros.org/wiki/kinect_aux">
